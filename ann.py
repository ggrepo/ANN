...
#1. funkcja aktywacji -  musi określic sposób obliczania wartosci sygnalu wyjsciowego neuronu na podstawie wartosci tego sumarycznego pobudzenia
#  uzywana  w sieciach jednokierunkowych
...
def sigmoid(z):
    ...
    return g
#2. Obliczanie gradientów dla funkcji sigmoidalnej; jak zmienia sie funkcja sigm
def d(z):
